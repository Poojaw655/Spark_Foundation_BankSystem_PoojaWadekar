...
<body style="background: #909090;background-size: 100%">
...
if (isset($_GET['del']) && !empty($_GET['del']))
{
 ...
 ?>
<div class="container" >
<div class="card w-100 text-center shadowBlue" style="background: linear-gradient(to top, #ffffff 0%, #003366 100%)">
  <div class="card-header" >
   <div style="color: white; font-size: 25px"; align="text-center" > <b>All Staff Accounts</b></div>  <button class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#exampleModal" style="color: white" ><b>Add New Account</b></button>
  </div>
  <div class="card-body" >
