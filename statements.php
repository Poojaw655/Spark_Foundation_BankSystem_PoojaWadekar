...
<div class="container">
  <div class="card  w-75 mx-auto" style="background: linear-gradient(to bottom, #669999 0%, #ccffcc 100%)">
  <div class="card-header text-center" style="font-weight: bolder;">
    Transaction Have You Done!!
  </div>
  <div class="card-body">
    <?php 
  ...
  <div class="card-footer text-muted" style="font-weight: bolder">
