...
<body style="background-image: url('images/7.jfif');;background-size: 100%">
...
<div class="container">
<div class="card w-100 text-center shadowBlue" style=" background: linear-gradient(to top, #ffffff 0%, #669999 100%)">
    ...
    ?>
      <tr>
        ...
        <td>
          ...
          <a href="mnotice.php?id=<?php echo $row['id'] ?>" class="btn btn-light btn-sm" data-toggle='tooltip' title="Send notice to this">Send Notice</a>
